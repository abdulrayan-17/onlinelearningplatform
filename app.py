...
""".format(otp)
    ...
    server.login('abdulrayan2003@gmail.com', 'lwok wxvn gkgo krgd')
    server.sendmail('abdulrayan2003@gmail.com', to_email, msg.as_string())
    server.quit()
...
def send_new_course_email( email_content):
    email_address = 'abdulrayan2003@gmail.com'  # Your Gmail email address
    app_password = 'lwok wxvn gkgo krgd '# Your app-specific password
...
def start_npm():
    try:
        ...
        frontend_project_path = r'\Users\abdul\Downloads\onlinelearningplatform'
